...
/** CTA block at the end of each blog post — client component for onClick tracking. */
  ...
  return (
    <div className="relative flex flex-wrap items-center justify-center gap-3">
      <Link
        ...
        onClick={() => trackEvent("quote_click", { link_location: "blog_post_cta", label: "Get a Free Quote" })}
      >
        Get a Free Quote
      ...
      <a
        ...
        onClick={() => trackEvent("whatsapp_click", { link_location: "blog_post_cta" })}
      >
