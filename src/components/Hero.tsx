        ...
        <div className="mx-auto max-w-4xl w-full px-6 py-16 lg:py-20 text-center flex flex-col items-center">
          ...
          <div className="h-ctas flex flex-wrap items-center justify-center gap-3">
            <Link
              ...
              onClick={() => trackEvent("quote_click", { link_location: "hero", label: HERO_CONTENT.ctaPrimary.label })}
            >
            ...
            <a
              ...
              onClick={() => trackEvent("whatsapp_click", { link_location: "hero" })}
            >
            ...
            <a
              href={HERO_CONTENT.ctaPhone.href}
              className="inline-flex items-center gap-2 rounded-full border border-white/30 bg-white/10 backdrop-blur-sm px-6 py-3.5 text-sm font-semibold text-white transition-all duration-200 hover:bg-white/20 hover:-translate-y-0.5"
              onClick={() => trackEvent("phone_click", { link_location: "hero" })}
            >
              <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 shrink-0">
