...
const services = [
  {
    ...
    desc: "Certified move-out cleaning to help secure your full deposit and meet agent-approved standards.",
  ...
  {
    title: "Deep Cleaning",
    desc: "A full, detailed deep clean for neglected spaces or when you need a complete property refresh.",
  ...
  },
  {
    ...
    desc: "Deep cleaning for ovens, extractors, fridges, freezers, and all kitchen appliances.",
      ...
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between gap-4 mb-10">
          <div>
            ...
            <h2 className="text-4xl font-bold text-primary mt-1">Our Core Services</h2>
          </div>
          <Link
            href="/contact"
            className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-primary text-white font-semibold text-sm hover:bg-primary-light transition-colors shrink-0"
          >
            Get a Free Quote
          ...
          {services.map((s, i) => {
            ...
            return (
              ...
              >
                ...
                {/* Gradient overlay — always on, stronger at bottom */}
                ...
                {/* Expanded: text content at bottom */}
                <div
                ...
                >
                  ...
                  <span className="inline-flex items-center gap-1.5 text-xs font-semibold text-accent-light mt-4 hover:text-white transition-colors">
                    Learn more
        ...
        <div className="lg:hidden grid grid-cols-1 sm:grid-cols-2 gap-4">
          {services.map((s) => (
            <div
              key={s.title}
              className="group relative h-56 rounded-2xl overflow-hidden cursor-pointer shadow-md"
            >
              {/* Full-bleed image */}
              <Image
                src={s.image}
